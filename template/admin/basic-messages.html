...
<div id="main">
    ...
    <section id="content_wrapper">
        ...
        <section id="content" class="table-layout animated fadeIn">
            <!-- Column Left -->
            <aside class="chute chute-left chute-icon-style chute290 bg-system" data-chute-height="match">
                <div class="chute-icon"></div>
                <div class="chute-container pt30">
                    <!-- New Message -->
                    <button id="quick-compose" type="button" class="btn btn-alert light btn-block fw600">New message</button>
                    <!-- Message Menu -->
            ...
            <div class="chute chute-center pn">
              <!-- Topbar -->
