        ...
        var demoHighAreas = function () {
            ...
            if (area1.length) {
                ...
                $('#high-area').highcharts({
                    colors: [bgAlert, bgPrimary, bgInfoDrAlt],
                    credits: false,
                    chart: {
                        type: 'areaspline',
                        plotBorderWidth: 1
                    ...
                    xAxis: {
                        //categories: ['Label 1', 'Label 2', 'Label 3', 'Label 4', 'Label 5', 'Label 6', 'Label 7', 'Label 8'],
                    ...
                    series: [{
                        id: 0,
                        name: 'Google',
                        data: [0, 18, 20, 40, 46, 28, 40, 28, 73, 75, 65, 80, 76, 44, 45, 19, 38, 24, 30, 52, 20, 0],
                        fillColor : {
                            linearGradient : {
                                x1: 1,
                                y1: 0,
                        ...
                        id: 1,
                        name: 'Bing',
                        data: [0, 34, 25, 21, 15, 26, 28, 48, 49, 64, 44, 54, 53, 77, 30, 14, 9, 11, 2, 5, 9, 0],
                        fillColor : {
                            linearGradient : {
                                x1: 1,
                                y1: 0,
                            ...
                            stops : [
                                // [0, bgPrimary],
                                // [1, bgInfo]
                                [0, 'rgba(17,168,187,0.8)'],
                                [1, 'rgba(17,168,187,0.8)']
                            ]
                        }
                    }, {
                        id: 2,
                        name: 'Twitter',
                        data: [0, 4, 8, 11, 14, 22, 17, 33, 18, 28, 18, 16, 14, 22, 23, 38, 30, 40, 43, 30, 15, 0],
                        fillColor : {
                            linearGradient : {
                                x1: 1,
                                y1: 0,
